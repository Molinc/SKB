(() => {
  document.addEventListener("DOMContentLoaded", () => {
    ...
    function createPage() {
      ...
      container.append(headerSite, main);

      headerSite.append(logoSite, headerInputSearch);

      main.append(textHead, tableContainer, addClient);
    ...
    function validTextInput(input) {
      ...
      input.addEventListener("blur", () => {
        ...
        if (input.value !== "") {
          input.value =
            validate[0].toUpperCase() +
            validate.slice(1).replace(/\s{2,}/g, " ");
        }
      });
    }
    ...
    function renderingTable(array) {
      ...
      for (const i of array) {
        ...
        btnContainer.append(changeClient, deleteClient);
        ...
        for (const contact of i.contacts) {
          ...
          let contacs = document.createElement('b');
          contacs.style.color = "#B89EFF";
          contacs.textContent = contact.value;
    ...
    function createFormClient() {
      ...
      placeholderSurname.append(inputSurname, placeholderSurnameText);
      placeholderName.append(inputName, placeholderNameText);
      placeholderLastName.append(inputLastName, placeholderLastNameText);
    ...
    function clientModalAdd() {
      ...
      saveClient.addEventListener("click", (e) => {
        e.preventDefault();
        validate(
          createFormClients.inputName,
          createFormClients.inputSurname,
          createFormClients.formClient,
          saveClient,
          postData
        );
      });
    ...
    function changeClientModalWindow() {
      ...
      createModal.modalWindow.append(headerText, createFormClients.formClient);
      createFormClients.formClient.append(changeClientSave, changeClientDelete);
    ...
    function addContactList(value) {
      ...
      contactItem.append(selectContact, inputContact, btnDelete);
    ...
    function createModalWindow() {
      ...
      document.body.append(blackout, modalWindow);
    ...
    function deleteClientModalWindow() {
      ...
      deleteTextContainer.append(pHead, pQuestion, acceptDelete, cancelDelete);
